...
%endif
           --with-brotli=yes
%{__sed} -i 's|^hardcode_libdir_flag_spec=.*|hardcode_libdir_flag_spec=""|g' builds/unix/libtool
%{__sed} -i 's|^runpath_var=LD_RUN_PATH|runpath_var=DIE_RPATH_DIE|g' builds/unix/libtool
%{make_build}
...
%{__mv} tutorial/example3.cpp.utf8 tutorial/example3.cpp
popd
